...
const start = function(filePath) {
    ...
    // rel_fc_126_Whole_cell_1	rel_fc_127L_Whole_cell_1	rel_fc_127H_Whole_cell_1	rel_fc_128L_Whole_cell_1	rel_fc_128H_Whole_cell_1	rel_fc_129L_Whole_cell_1	rel_fc_129H_Whole_cell_1	rel_fc_130L_Whole_cell_1	rel_fc_130H_Whole_cell_1	rel_fc_131L_Whole_cell_1
    const tempStrConstructor = (z1, z2) => `rel_fc_${z1}_Whole_cell_${z2}`;
    const fcs = [126, "127L", "127H", "128L", "128H", "129L", "129L", "130L", "130H", "131L"];
    const experimentHeaderArray = createExperimentHeaderArrays(array, tempStrConstructor, [1,2,3], fcs);
