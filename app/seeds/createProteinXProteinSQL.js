...
const createInsertIntoFile = (data) => {
    try {
        ...
        fs.writeFileSync('private/pg_dumps/insert_into_protein_protein.txt', protein_proteins_string, {flag: 'w'}, function (err) {
            if (err) {
                console.log('appending error', err)
            }
        });
        fs.writeFileSync('private/pg_dumps/insert_proteins.txt', protein_string, {flag: 'w'}, function (err) {
            if (err) {
                console.log('appending error', err)
            }
        })
